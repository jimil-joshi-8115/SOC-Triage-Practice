...
```
SOC-Triage-Practice/
├── Cases/                     → 20 closed triage cases (ticket → investigation → verdict)
...
See [Metrics/triage_scorecard.md](Metrics/triage_scorecard.md) for the full case-by-case log: every verdict, every correction made and why, and the key lessons distilled from all 20 cases.
